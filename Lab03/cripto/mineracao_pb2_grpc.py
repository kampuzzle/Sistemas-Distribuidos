...
import mineracao_pb2 as mineracao__pb2
...
class apiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getTransactionId = channel.unary_unary(
                ...
                request_serializer=mineracao__pb2.void.SerializeToString,
                response_deserializer=mineracao__pb2.intResult.FromString,
                )
        self.getChallenge = channel.unary_unary(
                '/main.api/getChallenge',
                request_serializer=mineracao__pb2.transactionId.SerializeToString,
                response_deserializer=mineracao__pb2.intResult.FromString,
                )
        ...
        self.submitChallenge = channel.unary_unary(
                ...
                request_serializer=mineracao__pb2.challengeArgs.SerializeToString,
                response_deserializer=mineracao__pb2.intResult.FromString,
                )
        ...
        self.getSolution = channel.unary_unary(
                ...
                request_serializer=mineracao__pb2.transactionId.SerializeToString,
                response_deserializer=mineracao__pb2.structResult.FromString,
                )
...
def add_apiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'getTransactionId': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=mineracao__pb2.void.FromString,
                    response_serializer=mineracao__pb2.intResult.SerializeToString,
            ),
            'getChallenge': grpc.unary_unary_rpc_method_handler(
                    servicer.getChallenge,
                    request_deserializer=mineracao__pb2.transactionId.FromString,
                    response_serializer=mineracao__pb2.intResult.SerializeToString,
            ),
            ...
            'submitChallenge': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=mineracao__pb2.challengeArgs.FromString,
                    response_serializer=mineracao__pb2.intResult.SerializeToString,
            ),
            ...
            'getSolution': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=mineracao__pb2.transactionId.FromString,
                    response_serializer=mineracao__pb2.structResult.SerializeToString,
            ),
    }
...
class api(object):
    ...
    def getTransactionId(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/main.api/getTransactionId',
            mineracao__pb2.void.SerializeToString,
            mineracao__pb2.intResult.FromString,
    ...
    def getChallenge(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/main.api/getChallenge',
            mineracao__pb2.transactionId.SerializeToString,
            mineracao__pb2.intResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def submitChallenge(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/main.api/submitChallenge',
            mineracao__pb2.challengeArgs.SerializeToString,
            mineracao__pb2.intResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def getSolution(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/main.api/getSolution',
            mineracao__pb2.transactionId.SerializeToString,
            mineracao__pb2.structResult.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
